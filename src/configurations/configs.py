...
class Configs:
    """
    The instance of this class holds nlp-web-service configurations.
    """
    ...
    def __init__(self, app: Sanic):
        """
        This method initializes the instance of the npl-web-service configurations.
    ...
    def get_instance(app: Sanic = None):
        """
        This method returns an instance of the nlp-web-service configurations.
